...
function moveElement(elementID,final_x,final_y,interval) { <!--这一段明显示来移动的 -->
...
function classNormal(iFocusBtnID,iFocusTxID){  <!--classNormal和classCurrent也是分别来制定现在显示的图片和将显示的图片，这里在得倒iFocusBtns和iFocusTxs列表-->
